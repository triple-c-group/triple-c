                ...
                <div className="col-start-1 col-end-6 ">  
                    <form className="flex flex-row justify-center mt-2 w-full">   
                        <div className="relative">
                            ...
                            <button type="submit" className="text-white absolute -end-16 bottom-0 bg-sky-700 hover:bg-sky-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-r-lg text-sm px-4 py-1 border">{Search}</button>
                        </div>
                    </form>
                </div>  
                <button
                    className="col-end-7 col-span-1 rounded mb-40 ml-6 p-1 text-sm font-bold text-gray-300 sm:text-xl hover:scale-125"
